		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Production Stopage",
									"targetURL": "#zproductionstopage-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zproductionstopage-display": {
								"semanticObject": "zproductionstopage",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zproductionstopage",
									"url": sap.ui.require.toUrl("zproductionstopage")
								}
							}
						}
					}
